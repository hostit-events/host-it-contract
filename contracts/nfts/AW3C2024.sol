 ...
 *
 * NFT Contract to mint Anambra Web3 Conference 2024 tickets to attendees
 */
contract AW3C2024 is ERC721AUpgradeable, AccessControlUpgradeable {
    // =============================================================
    //                       INITIALIZER LOGIC
    // =============================================================

    function initialize(address _admin) public initializerERC721A initializer {
        __ERC721A_init("Anambra Web3 Conference 2024", "AW3C2024");
