 ...
 *
 * NFT Contract to mint ITC 2024 tickets to attendees
 */
contract ITC2024 is ERC721AUpgradeable, AccessControlUpgradeable {
    // =============================================================
    //                       INITIALIZER LOGIC
    // =============================================================

    function initialize(address _admin) public initializerERC721A initializer {
        __ERC721A_init("ITC Freshers' Tech Fest", "ITC2024");
